...
public class CreateSellerOrder {
    ...
    private By createOrderBtn =
        By.xpath("//button[.//span[normalize-space()='Create Order']]");

    private By singleOrderOption =
        By.xpath("//span[normalize-space()='Single Order']");

    public CreateSellerOrder(WebDriver driver, WebDriverWait wait) {
        this.driver = driver;
        this.wait = wait;
    }

    public void openSingleOrder() {
        wait.until(ExpectedConditions.elementToBeClickable(createOrderBtn)).click();
        wait.until(ExpectedConditions.elementToBeClickable(singleOrderOption)).click();
    }
